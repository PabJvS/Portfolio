						...
						<div className="relative w-auto my-6 mx-auto max-w-sm">
							...
							<div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
								...
								<div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
									<h3 className="text-3xl font-semibold">HeroApp</h3>
									<button
								...
								<div className="relative p-6 flex-auto">
									<p className="my-4 text-slate-500 text-lg leading-relaxed">
										Este es un proyecto realizado empleando React Js, el cual
										consiste en mostrar héroes de Marvel y DC con información
										estática consumida desde un JSON. Se implementaron hooks de
										useContext, useReducer y adicionalmente rutas públicas y
										protegidas utilizando la librería de react-router-dom.
									</p>
								</div>
								{/*footer*/}
